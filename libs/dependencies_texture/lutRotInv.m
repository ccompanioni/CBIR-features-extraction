function [lookup_table] = lutRotInv(FeatureName)
    ...
    % function [lookup_table] = lutRotInv(FeatureName)
    % Returns a look-up table to compute the rotation invariant versions LBP81 and CCR81
    
    %Input:     FeatureName (feature name. Can be 'LBP81ri', 'LBP81riu2', 'CCR81ri' or 'CCR81riu2')
    %Output:    lookup_table (Lookup table for rotationally-equivalent patterns. 
    %           Each entry of the vector maps the corresponding pattern to a rotationally-invariant index)
    %
